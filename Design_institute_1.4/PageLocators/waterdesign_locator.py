...
class IndexWaterDesignPageLocator:
    """
    首页添加项目元素定位
    """
    # 首页'工作台'菜单定位
    ...
    """
    # 水利设计
    waterdesign_loc = (By.XPATH,'//a[@title="水利设计工程"]/parent::li')
    # 工程类型选项
    projecttypechoice_loc = (By.XPATH,'//label[contains(text(),"工程类型")]/following-sibling::div')
    # 建设性质选项
    consult_xingzhi = (By.XPATH,'//label[contains(text(),"建设性质")]/following-sibling::div')
    # 工程规模文本框
    ...
    # 水保专业负责人
    shuibao_fuze = (By.XPATH,'//li[text()="水保专业负责人"]')
    # 环保专业设计人
    huanbao_sheji = (By.XPATH,'//li[text()="环保专业设计人"]')
    # 环保专业负责人
    huanbao_fuze = (By.XPATH,'//li[text()="环保专业负责人"]')
    # 添加成员
    ...
    # 01-地质测量水文资料  勾选
    waterquality_file = (By.XPATH, '//span[@id="team-tree3_3_check"]')
    # 01-设计输入资料 选择按钮
    design_input = (By.XPATH,'//a[@id="team-tree3_2_a"]//b')
    # 01-设计输入资料  选择海清
    design_choice = (By.XPATH,'//span[@id="team-tree1_4_check"]')
    # 01-地质测量水文资料  选择按钮
    waterquality_choosebutton = (By.XPATH, '//a[@id="team-tree3_3_a"]//b')
    #  01-地质测量水文资料  选择海若梦
    hairuomeng_choosebutton = (By.XPATH, '//span[@id="team-tree1_6_check"]')
    # 确定按钮
    ...
    # 01设计输入资料
    input_file = (By.XPATH,'//span[@id="team-tree3_3_check"]')
    # 同步校审文件勾选
    ...
    """
    # 删除元素
    delete1_loc = (By.XPATH, '//span[text()="测试_水利设计工程"]/ancestor::ul//span[text()="删除"]')
    # 删除确定
